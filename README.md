...
Here are some fundamental things you can do with this app:-
...
This project shows a clear implementation, plan, structure and testing of a complete API.

## Getting Started

### Pre-requisites and Local Development
For Developers, you will need to have python3 installed on your machine to run this program.
...
- Request Body:
`curl -X POST -H "Content-Type: application/json" -d '{"previous_questions":[1, 2, 3], "category":{"id": 1, "type": "Reservoir"}}' http://localhost:5000/quizzes`
...
- Request Body:
`curl http://localhost:5000/questions/search?search_term=reservoir`
